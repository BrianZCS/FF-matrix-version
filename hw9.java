import java.util.*;
//Use Matric to store all

///Reference
///I use some of ideas in the link below
...
public class hw9 {
	public static void main(String[] args) {
		...
		while (instances-- > 0) {
			...
			MaxFlow m = new MaxFlow(numNode);
			int graph[][] = new int[numNode][numNode];// default is 0
			while (numEdge-- > 0) {
			...
			System.out.println(m.fordFulkerson(graph, 0, numNode - 1));
		}
		scan.close();
	}
}